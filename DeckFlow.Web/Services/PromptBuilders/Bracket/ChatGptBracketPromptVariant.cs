...
/// <summary>
/// Builds a bracket classification and optional balancer prompt body formatted for ChatGPT.
/// Uses markdown <c>##</c> headers per ChatGPT's markdown-headed prompt contract.
/// </summary>
internal sealed class ChatGptBracketPromptVariant : IBracketPromptVariant
{
        ...
        IReadOnlyList<BracketTier> tiers)
    {
        ...
        // "count your tutors" rule, but specific high-impact tutors (Demonic Tutor, Vampiric
        // Tutor, etc.) remain on the Game Changers list and DO count toward the GC total.
