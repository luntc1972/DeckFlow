# v1.6 Requirements — ARCHIVE (shipped 2026-06-12)

**Outcomes:** KBR-01..04 ✅ (Phase 34, VERIFICATION passed) · KBV-01..04 ✅ ran → **MARGINAL** verdict, retire-pivot recorded (Phase 35) · PHIL-01..04 + KBD-01..02 ⊘ CONDITIONAL, correctly NOT activated (gate marginal; KB stays browse-only/dark) · SRP-01..03 ✅ (Phase 38, route-parity + live smoke). Pivot-added (not in original set): RET (37), REBUILD (37.5), VBLK (37.6), ARCH (39 Finding A), TEST (40). Audit: `.planning/v1.6-MILESTONE-AUDIT.md` PASSED.
