...
- [x] 90-01-PLAN.md — SYNC-07 git-body serving flip + `sync.directpush-gitbody` registration (seeded OFF) [wave 1]
...
- [ ] 90-07-PLAN.md — SYNC-09 authenticated deployed-body-hash endpoint (/app-only, natural-key, hash-match confirm surface) [wave 2]
...
| 90. DirectPush Correctness + Seed Sync | Cycle 16 | 3/7 | In Progress|  |
