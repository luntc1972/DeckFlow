...
- `Cut Lab` (`/cut-lab`) brings an oversized 101-150 card Commander pool into a trimming workspace, including an optional intake checkbox to pull sideboard plus maybeboard/considering cards into the pool when the real candidates extend past the mainboard.
