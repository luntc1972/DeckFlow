---
source: "RebellLily"
title: "My EXCLUSIVE Deadly Disguise Commander Precon Reveal!"
url: "https://www.youtube.com/watch?v=yQ8g1dWT6gU\u0026list=UUX8LtC40Hs-QKd7kDpUW4Vg"
video_id: "yQ8g1dWT6gU"
tags:
  archetype: ["value-engine","tokens","midrange"]
  bracket: ["Core"]
  card_category: ["ramp","removal","draw","board-wipe","recursion","tutor","finishers"]
generated_utc: "2026-06-09T05:48:26Z"
---

## Summary

This video reveals the Deadly Disguise Commander precon from Murders at Karlov Manor. The face commander, Kaya/Coppercoat eyes-of-the-glade (Naya detective), draws a card when a creature turned face up this turn deals combat damage, and can flip a face-down attacker for a card. The deck centers on disguise (cast face-down 2/2 for three mana, pay disguise cost to flip) and cloak mechanics. Key new cards: True Identity (scry/draw on flips, once per turn), Veiled Ascension (gives face-down creatures flying counters, cloaks library top each upkeep), Panoptic Projector (doubles flip-triggered abilities, cost reduction), and flip payoffs like Experiment Twelve (doubles power), Prying Lifter Ooze (makes ooze tokens), and Bolt Bender (redirects spells). Secondary commander Dosana, Rage Mother rewards 2/2 creatures with card draw and +3/+3 on attack. The deck includes 20 morph creatures (Master of Pearls, Den Protector, Hidden Dragonslayer, Exalted Angel) plus morph/power-two synergies and Yedora for recursion. Mana base has Arcane Signet, Sol Ring, Sakura-Tribe Elder, ramp spells, and Kessig Wolf Run. Showstopping Surprise and Unexplained Absence provide removal/finishers. Presented as a fun, tricky Naya deck with explosive hidden-creature finishers, good for play or upgrading.
...
**Archetypes/Strategy:** value-engine, tokens, midrange
**Format/Bracket:** Core
**Card Categories:** ramp, removal, draw, board-wipe, recursion, tutor, finishers
