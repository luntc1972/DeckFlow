...
public sealed class ToolRegistry : IToolRegistry
{
    ...
    [
        ...
        Create("manabase", "Mana Base", "/manabase", ToolNavSection.Analyze, "tool.manabase.enabled", false, "Mana Base", "Score a deck's lands and colored sources — Frank Karsten's source-count math, extended to weight rocks, dorks, and MDFCs and to count tapped vs. untapped lands. No AI needed.", "manabase", DeckPageTab.Manabase, true),
        ...
        Create("deck-sync", "Deck Sync", "/sync", ToolNavSection.Build, "tool.deck-sync.enabled", false, "Deck Sync", "Reconcile a Moxfield deck against an Archidekt deck (either direction) and generate add/cut text for the target.", "deck-sync", DeckPageTab.Sync, false, "/resolve", "/api/deck/diff"),
