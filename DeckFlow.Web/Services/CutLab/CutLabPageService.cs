...
internal sealed class CutLabPageService : ICutLabPageService
{
        ...
        EdhrecThemeResult planThemeResult)
    {
        ...
        return new CutLabState
        {
            ...
            // Why: Floors are re-derived per request against the freshly resolved commander, so
            // this pre-analysis state deliberately carries none; ProcessAsync re-applies
            // priorState.RoleFloors at line 468 during floor resolution.
            RoleFloors = [],
