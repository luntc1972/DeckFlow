...
public sealed class FeatureFlagStoreSeedTests : IDisposable
{
    ...
    [InlineData("analysis.cut-lab.functional-twins", false)] // Cut Lab functional-twins dark launch
    [InlineData("analysis.cut-lab.proven-equivalence", false)] // Cut Lab deterministic disclosure-only dark launch
    ...
    public void PostgresSeedSql_SeedsMulliganEvalFlag_On()
    {
        ...
        Assert.Contains("('analysis.cut-lab.functional-twins', FALSE)", postgresSql, StringComparison.Ordinal);
