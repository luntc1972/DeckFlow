---
source: "RebellLily"
title: "Epic Commander Game Using Modern Horizons 3 Decks"
url: "https://www.youtube.com/watch?v=4k-Ts1NHZDY\u0026list=UUX8LtC40Hs-QKd7kDpUW4Vg"
video_id: "4k-Ts1NHZDY"
tags:
  archetype: ["lands","ramp","value-engine","tokens"]
  bracket: ["Upgraded"]
  card_category: ["ramp","finishers","recursion","draw","utility"]
generated_utc: "2026-06-09T05:48:26Z"
---

## Summary

Four-player game pits the four Modern Horizons 3 precons against each other: Jund Graveyard Overdrive (Disa the Restless), Simic Tricky Terrain (Omo, Queen of Vesuva), five-color Eldrazi Incursion (Ulalek), and Creative Energy (Satya). Omo proves strongest: her everything-counters turn lands into every type, assembling Urza Tron and Titan-style ramp early. The deck stalls and ramps, then explodes via Mana Reflection (copied with Replication Technique) doubling every land tap, plus Apex Devastator cascading into more lands, Wonderscape Sage loops, and Tatyova card draw. It threatens a Dark Depths + Thespian's Stage Marit Lage combo, though Tectonic Edge disrupts it once. Satya's energy deck pops off mid-game with Blaster Hulk dealing eight divided damage and copy triggers, eliminating one opponent. Disa cheats Lhurgoyfs (Baragoth, Lifegoyf) into play off Faithless Looting discards. Eldrazi durdles with Awakening Zone tokens and mind-render mill. The Omo player ultimately generates 40+ mana, casts Drown in Dreams to deck an opponent, survives a counterattack, and resolves Pyrogoyf chains for lethal. Key lessons: land-type matters payoffs enable Tron/Titan strategies, mana doublers scale explosively, and graveyard recursion provides redundant threats.
...
**Card Categories:** ramp, finishers, recursion, draw, utility
