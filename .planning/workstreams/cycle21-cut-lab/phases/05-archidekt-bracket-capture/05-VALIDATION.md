...
| 05-02-02 | 02 | 2 | BRKT-02, BRKT-03 | T-05-04, T-05-06, T-05-07, T-05-13 | Implements Task 1's repository and Postgres-fact specifications, including D-10 per-record upsert gating. | unit/schema | See Task 2's acceptance criteria and gates in `05-02-PLAN.md`. | Yes | pending |
...
| 05-03-03 | 03 | 3 | BRKT-02, BRKT-03 | T-05-09, T-05-11, T-05-14 | URL path and store→repository persistence are verified per Task 3. The raw readback asserts every metadata value, defeating a partial-forward mutation. | unit + build | See Task 3's gates in `05-03-PLAN.md`. | Yes | pending |
