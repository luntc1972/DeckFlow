---
source: "RebellLily"
title: "This is the best cEDH deck I\u0027ve ever played"
url: "https://www.youtube.com/watch?v=45w2eZI_naA\u0026list=UUX8LtC40Hs-QKd7kDpUW4Vg"
video_id: "45w2eZI_naA"
tags:
  archetype: ["combo","ramp","value-engine"]
  bracket: ["cEDH"]
  card_category: ["ramp","tutor","draw","counter","removal","protection","recursion","win-cons","finishers"]
generated_utc: "2026-06-09T05:48:26Z"
---

## Summary

Rograkh/Thrasios (Temur) cEDH deck the speaker calls the most powerful they've played, sent by Sam Black. Core identity: a Gaea's Cradle deck that vomits mana through natural ramp and rocks, then assembles flexible combos rather than relying on one specific payoff. Two priorities every game: find Gaea's Cradle, then find Dockside, with many tutors (Invasion of Ikoria, Tezzeret, Imperial Recruiter, Spellseeker, Trophy Mage, Muddle the Mixture, Transmute Artifact) designed to be highly flexible. Combo lines include Machine God's Effigy + Devoted Druid, Cloudstone Curio + Cloud of Fairies, Shrieking Drake + Earthcraft + enchantments (Utopia Sprawl, Wild Growth, Fertile Ground, Generous Ent for basics), Kinnan + Basalt Monolith, and Eternal Witness + Snap. Wincons: Whole Breaker of Horror, Finale, Thassa's Oracle, lightning bolt the table. Strength shown via goldfishing: even mana-heavy hands produce turn-three kills, and the fail state (lots of mana + Thassa) is strong. Plays aggressive counters (Pact of Negation over Force of Negation) and a Twister since it dumps mana fast. Proposed cuts: Itale, Veil of Summer, possibly Cloud of Fairies; adds Seedborn Muse, Borne Upon a Wind. Always presents the win.
...
**Archetypes/Strategy:** combo, ramp, value-engine
**Format/Bracket:** cEDH
**Card Categories:** ramp, tutor, draw, counter, removal, protection, recursion, win-cons, finishers
