...
- **Conditional Mox modeling** — the five commander-legal conditional Moxen stay in the color-source pool, but they are no longer all treated as perfect untapped fast mana. **Mox Amber** and **Chrome Mox** are capped to your commander's color identity; Amber keeps full untapped fast-mana credit only in legend-dense decks, **Mox Opal** does the same only in artifact-dense decks, **Mox Tantalite** is always treated as delayed/tapped, and **Mox Diamond** keeps full untapped fast-mana credit. This is a density-graded heuristic, not a turn-by-turn simulation.
