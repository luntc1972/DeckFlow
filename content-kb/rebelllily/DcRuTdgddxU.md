---
source: "RebellLily"
title: "MTG is Making Them Broke"
url: "https://www.youtube.com/watch?v=DcRuTdgddxU\u0026list=UUX8LtC40Hs-QKd7kDpUW4Vg"
video_id: "DcRuTdgddxU"
tags:
  archetype: []
  bracket: []
  card_category: []
...
- are you placing the order for Assassin's Creed? Yeah it's pretty limited. Can I add on to the order for myself?
- Kid you've already spent your June salary on MH3 Singles. You're going to end up owing us at this rate.
- I want to build an EDH deck with only cards from the set.
- Need some help? Yeah I would like that. We'll crack the box together when we get the order.
