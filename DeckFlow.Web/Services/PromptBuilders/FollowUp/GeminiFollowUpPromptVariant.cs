...
/// <summary>
/// Builds a deck-comparison follow-up prompt body formatted for Gemini (markdown persona-scaffold with schema-strictness language).
/// </summary>
internal sealed class GeminiFollowUpPromptVariant : IFollowUpPromptVariant
{
    /// <summary>The AI platform this variant targets.</summary>
    public AiPlatform Platform => AiPlatform.Gemini;

    /// <summary>
    /// Builds the Gemini-targeted follow-up prompt text for the given comparison schema.
    /// Body is a byte-for-byte copy of the pre-refactor BuildFollowUpPromptGemini switch arm (Phase 15-02).
    /// </summary>
