...
public sealed class ChatGptJsonTextFormatterServiceTests
{
    ...
    {
        Assert.Equal(string.Empty, ChatGptJsonTextFormatterService.ExtractJsonPayload(string.Empty));
        Assert.Equal(string.Empty, ChatGptJsonTextFormatterService.ExtractJsonPayload("   \n  "));
    }
    ...
    public void ExtractJsonPayload_extracts_inner_when_result_tag_wraps_json()
    {
        ...
        var result = ChatGptJsonTextFormatterService.ExtractJsonPayload(input);
