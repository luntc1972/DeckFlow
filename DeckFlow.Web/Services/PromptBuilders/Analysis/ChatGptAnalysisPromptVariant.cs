...
/// <summary>
/// Builds a deck-analysis prompt body formatted for ChatGPT (markdown-headed, fenced JSON output).
/// </summary>
internal sealed class ChatGptAnalysisPromptVariant : IAnalysisPromptVariant
{
    ...
    /// <summary>
    /// Builds the ChatGPT-targeted analysis prompt text for the given request.
    /// Body preserves the pre-refactor BuildAnalysisPromptChatGpt switch arm shape, with shared guidance extracted in quick task 260527-mfl.
    /// </summary>
    public string Build(
