...
- **Commits**: Plain default-author commits, no Co-Authored-By trailer; update release notes for releases, `docs/features.md` for features, and the specific documentation file for other behavior changes; commit per logical change
