...
- **Manabase research-gap closure** - bounded gap set from the 2026-07-12 research-vs-implementation audit: MBGAP-01 conditional-restriction lands (Cavern/Ziggurat/Nykthos), MBGAP-02 untapped-land cycles Phase 2 (fast/slow/Verge/Vivid/ELD), MBGAP-03 ritual land-target re-judge (RIT O-4, unblocked by 2026-07-11 flag flips), MBGAP-04 multiplayer threshold research, MBGAP-05 verdict polish batch, plus Tier-3 minors. Context ready: `.planning/phases/manabase-research-gap-closure/CONTEXT.md` (needs discuss-phase to lock scope; phase number assigned when scheduled).
