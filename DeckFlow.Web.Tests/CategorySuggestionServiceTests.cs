...
public sealed class CategorySuggestionServiceTests
{
    ...
    private sealed class FakeKnowledgeStore : ICategoryKnowledgeStore
    {
        ...
        public Task MarkUrlDeckProcessedAsync(string deckId, string? commanderName, ArchidektDeckMetadata? metadata, CancellationToken cancellationToken = default) => Task.CompletedTask;
