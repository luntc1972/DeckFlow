...
public sealed class ToolRegistry : IToolRegistry
{
    ...
    [
        ...
        Create("deck-modules", "Deck Modules", "/deck-modules", ToolNavSection.Build, "tool.deck-modules.enabled", false, "Deck Modules", "Import one baseline deck, assign 2-4 strategy alternatives with linked mana support, and compile a complete 100-card configuration.", null, DeckPageTab.DeckModules, false, "/deck-modules/import", "/deck-modules/compile", "/deck-modules/export"),
